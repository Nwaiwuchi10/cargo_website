    ...
    <div className="overflow-hidden text-gray-800">
      ...
      <div className="grid md:grid-cols-2 gap-10 px-4 sm:px-8 lg:px-20 py-20">
        <div className="bg-orange-600">
          ...
          <p className="mt-2 font-bold text-black md:text-4xl text-2xl p-5">25+ Years of Excellence</p>
        </div>
        <div className="flex flex-col justify-center">
          <h2 className="text-orange-600 text-xl font-bold uppercase mb-3">About Us</h2>
          <h1 className="text-3xl md:text-4xl font-bold mb-6">Your Trusted Logistics Partner</h1>
          <p className="text-gray-600 mb-6">
          With over two decades of experience, we provide efficient, reliable, and secure logistics services tailored to meet the unique needs of our clients. Whether it's local delivery or international freight, our team ensures your goods are handled with care and delivered on time.
          </p>
      ...
      <div className="bg-gray-50 py-20 px-4 sm:px-8 lg:px-20 text-center">
        <h2 className="text-orange-600 font-bold uppercase mb-2">Our Services</h2>
        <h3 className="text-2xl md:text-5xl font-bold mb-10" style={{}}>Comprehensive Logistics Solutions</h3>
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4 text-left">
          {[
            { icon: "fa-plane", title: "Air Freight", desc: "Ensure quick and reliable delivery of goods across international borders with our air freight services." },
            { icon: "fa-ship", title: "Ocean Freight", desc: "Comprehensive ocean freight solutions for large-scale cargo and cost-effective shipping needs." },
            { icon: "fa-truck", title: "Land Transport", desc: "Efficient and reliable land transport solutions to connect your goods with their destination." },
            { icon: "fa-store", title: "Warehousing", desc: "Secure and flexible warehousing options to store your goods before final delivery." },
          ].map((service, idx) => (
            <div key={idx} className="shadow-lg p-3 rounded-md" style={{textAlign:'center'}}>
      ...
      <div className="grid md:grid-cols-2 gap-6 px-4 sm:px-8 lg:px-20 py-4 items-center bg-gray-100">
        ...
        <div>
          ...
          <h3 className="text-2xl md:text-5xl font-bold mb-6">Fast, Reliable, and Secure Services</h3>
          <p className="text-gray-600 mb-6">
          Our commitment to excellence and customer satisfaction sets us apart in the logistics industry. We provide tailored solutions to meet your unique requirements with the highest level of professionalism.
          </p>
          ...
          <a href="#" className="inline-block mt-6 text-orange-600 font-bold hover:underline">Discover More</a>
        </div>
      </div>

      {/* Testimonials */}
      <div className="py-20 px-4 sm:px-8 lg:px-20 text-center">
        <h2 className="text-orange-600 text-sm font-bold uppercase mb-2">Testimonials</h2>
        <h3 className="text-2xl md:text-3xl font-semibold mb-10">What Our Clients Say</h3>
        <OwlCarousel
          className="owl-theme"
          loop
          margin={30}
        ...
        >
          {[
            { name: "Michael Brown", role: "Logistics Manager", img: brown, quote: "The team at Faster Logistics is highly professional and reliable. Their real-time tracking system is a game changer." },
            { name: "Emily Davis", role: "Freelancer", img: emily, quote: "I’m impressed by their commitment to excellence. They handled my fragile goods with utmost care." },
            { name: "James Wilson", role: "Retailer", img: james, quote: "Faster Logistics has been our trusted partner for years. Their service is unparalleled in the industry." },
            { name: "Sarah Johnson", role: "Business Owner", img: johnson, quote: "Faster Logistics provided exceptional service, ensuring my shipments arrived on time and in perfect condition. Highly recommend!" },
          ].map((item, i) => (
            <div key={i} className="bg-gray-100 rounded-lg p-10 shadow-md text-left relative">
              <i className="fa fa-3x fa-quote-right text-orange-600 absolute top-0 right-0"></i>
              <div className="flex items-center space-x-4 mb-4">
                <div>
                <img src={item.img} alt={item.name} className="w-full rounded-full" />
                </div>
                <div>
